...
export const ICON_MAP = {
  ...
  trash: TrashIcon,
  home: HomeIcon,
  synonym_highlight: SynonymHighlightIcon,
  synonym_duplicate: SynonymDuplicateIcon,
  plus: PlusIcon,
  plus2: Plus2Icon,
  minus: MinusIcon,
  "add-delay": AddDelayIcon,
  "add-entity": AddEntityIcon,
  "bot-says-colored": BotSaysColoredIcon,
  delay: DelayIcon,
  entity: EntityIcon,
  "entity-numeric-range": EntityNumericRangeIcon,
  "entity-regex": EntityRegexIcon,
  budget: BudgetIcon,
  date: DateIcon,
  time: TimeIcon,
  reorder: ReorderIcon,
  ...
  node: NodeIcon,
  story: StoryIcon,
  upload_icon: UploadIconIcon,
  task: TaskIcon,
  task_gray: TaskGreyIcon,
  taskbox: TaskboxIcon,
  outlier: OutlierIcon,
  business: BusinessIcon,
  botbreak: BotbreakIcon,
  bot: BotIcon,
  checkmark: CheckmarkIcon,
  "entity-email": EntityEmailIcon,
  client: ClientIcon,
  search: SearchIcon,
  filter: FilterIcon,
  filter_filled: FilterFilledIcon,
  transfer: TransferIcon,
  "empty-business-placeholder": EmptyBusinessPlaceholderIcon,
  error_response: RedExclamationIcon,
  success_response: TickGreenIcon,
  "tick-green": TickGreenIcon,
  question: QuestionIcon,
  "question-blue": QuestionBlueIcon,
  "question-book": QuestionBookIcon,
  arrow: ArrowIcon,
  "test-bot": TestBotIcon,
  "substory-empty": SubstoryEmptyIcon,
  quotes_open: QuotesOpenIcon,
  quotes_close: QuotesCloseIcon,
  template: TemplateIcon,
  template_general: TemplateGeneralIcon,
  template_substory: TemplateSubstoryIcon,
  template_substory_api: TemplateSubstoryApiIcon,
  "circle-more": CircleMoreIcon,
  paste: PasteIcon,
  haptik: HaptikIcon,
  profile: ProfileIcon,
  botTab: BotTabIcon,
  botTabColored: BotTabColoredIcon,
  templateTab: TemplateTabIcon,
  templateTabColored: TemplateTabColoredIcon,
  businessTab: BusinessTabIcon,
  businessTabColored: BusinessTabColoredIcon,
  grid: GridIcon,
